package ca.bc.gov.nrs.cbr.util;
 ...
 * source-directory token the CBR schema was built around, {@code IDIR\jsmith}. It goes into
 ...
 * <ol>
 *   <li><b>Provider normalisation.</b> CBR's CSS integration selects <em>IDIR - MFA</em>, which
...
public class JwtPrincipalUtil {
  ...
  /**
   * Realm aliases that mean "IDIR". {@code azureidir} is the one CBR actually sees (its CSS
  ...
  /**
   * The identity provider, normalised to the legacy WebADE source-directory token the CBR schema
