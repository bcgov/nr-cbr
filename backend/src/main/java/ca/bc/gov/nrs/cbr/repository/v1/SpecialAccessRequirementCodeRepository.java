...
/**
 * {@code THE.SPECIAL_ACCESS_RQMT_CODE}.
 */
@Repository
public interface SpecialAccessRequirementCodeRepository extends JpaRepository<SpecialAccessRequirementCodeEntity, String> {

  /**
   * Every code, ordered by description.
   *
   * <p>This is {@code CBR_GENERAL.FIND_SPECIAL_ACCESS_RQMTS}, which is a plain {@code SELECT … ORDER BY DESCRIPTION} over the
   ...
   */
  List<SpecialAccessRequirementCodeEntity> findAllByOrderByDescriptionAsc();
}
