package ca.bc.gov.nrs.cbr.repository;

import ca.bc.gov.nrs.cbr.exception.StoredProcedureException;
 ...
 */
public abstract class AbstractCbrRepository {

  private static final Logger log = LoggerFactory.getLogger(AbstractCbrRepository.class);

  protected final JdbcTemplate jdbcTemplate;

  protected AbstractCbrRepository(JdbcTemplate jdbcTemplate) {
