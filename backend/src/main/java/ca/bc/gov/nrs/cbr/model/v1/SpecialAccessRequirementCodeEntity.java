...
/**
 * {@code THE.SPECIAL_ACCESS_RQMT_CODE} — what is needed to reach a site.
 *
...
@Entity
@Immutable
@Table(name = "SPECIAL_ACCESS_RQMT_CODE", schema = "THE")
@Getter
@ToString
@EqualsAndHashCode(of = "specialAccessRequirementCode")
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class SpecialAccessRequirementCodeEntity {

  /** "Code representing a special access requirement." */
  @Id
  @Column(name = "SPECIAL_ACCESS_RQMT_CODE", unique = true, length = 10)
  private String specialAccessRequirementCode;
