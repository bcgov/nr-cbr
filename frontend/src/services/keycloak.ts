...
/**
 * BC Gov SSO (Keycloak, standard realm) client — the whole of CBR's OAuth wiring.
 *
 ...
 *
 * <p><b>`azureidir`, not `idir`.</b> CBR's CSS integration selects IDIR - MFA, which federates
